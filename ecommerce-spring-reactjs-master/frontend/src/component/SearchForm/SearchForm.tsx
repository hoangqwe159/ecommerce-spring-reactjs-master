...
type PropsType = {
    ...
    setFilteredData: (value: (((prevState: Array<Product>) => Array<Product>) | Array<Product>)) => void
...
const SearchForm: FC<PropsType> = ({data, searchByData, setFilteredData, setSearching}) => {
    ...
    const submitHandler = (event: FormEvent<HTMLFormElement>): void => {
        ...
        if (search.trim() !== '') {
            ...
            const filtered: Array<Product> = copiedData.filter((product: any) => {
                let searchKey: string = 'product';
